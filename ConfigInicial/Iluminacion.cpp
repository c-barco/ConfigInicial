...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glUniform3f(glGetUniformLocation(lightingShader.Program, "light.ambient"), 0.1f, 0.2f, 0.3f);
        ...
        glUniform3f(glGetUniformLocation(lightingShader.Program, "material.diffuse"), 0.1f, 0.5f, 0.6f);
        glUniform3f(glGetUniformLocation(lightingShader.Program, "material.specular"), 0.2f, 0.3f, 0.1f);
